  ...
  try {
    ...
    if (isPuroMarketing) {
      ...
      $(
        ...
        // Buscar título en diferentes estructuras de Emol
        const titulo = limpiarTexto(
        ...
        // Extraer descripción (puede venir después del timestamp o en <p>)
        let descripcion = limpiarTexto(
          $element
            .find("p")
            .text()
            .replace(/^\d{2}:\d{2}\s*\|\s*/, ""), // Remover timestamp si existe
        );
